...
const userSchema = new Schema<IUser>({
    ...
    gender: { type: String, enum: Gender, lowercase: true, required: true },
    address: { type: String, maxLength: [50, 'Address length must not exceed more than 50 characters'], required: true },
